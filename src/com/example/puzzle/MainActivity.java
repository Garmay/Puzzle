...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFragmentManager().beginTransaction().replace(R.id.main_lay, new PuzzleFragment()).commit();
	}
	
	/*GAME'S MAIN FRAGMENT*/
	public static class PuzzleFragment extends Fragment implements OnDragListener,OnTouchListener{
